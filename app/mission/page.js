          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg shadow-md p-6 text-center">
                <div className="w-32 h-32 rounded-lg overflow-hidden mx-auto mb-4 shadow-lg">
                  <img src="/images/generated/cultural-preservation-icon.jpg" alt="Cultural Preservation" className="w-full h-full object-cover" />
                </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 text-center">
                <div className="w-32 h-32 rounded-lg overflow-hidden mx-auto mb-4 shadow-lg">
                  <img src="/images/generated/global-connection-icon.jpg" alt="Global Connection" className="w-full h-full object-cover" />
                </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 text-center">
                <div className="w-32 h-32 rounded-lg overflow-hidden mx-auto mb-4 shadow-lg">
                  <img src="/images/generated/education-excellence-icon.jpg" alt="Excellence in Education" className="w-full h-full object-cover" />
                </div>
