...
export default function KiswahiliPlansPage() {
  const plans = [
    {
      name: "Trial Lesson",
      price: "FREE",
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-r from-teal-500 to-teal-600 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Kiswahili Language Programs</h1>
            <p className="text-xl max-w-3xl mx-auto">
              Open doors to East Africa's lingua franca through engaging Kiswahili lessons 
              with native speakers from Kenya, Tanzania, Uganda, and beyond.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6">Why Learn Kiswahili?</h2>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mr-3 mt-1"></i>
                    <div>
                      <strong>Widespread Communication:</strong> Kiswahili is spoken by over 100 million people 
                      across East Africa and is an official language of the African Union.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mr-3 mt-1"></i>
                    <div>
                      <strong>Gateway Language:</strong> Kiswahili opens doors to understanding multiple 
                      African cultures and serves as a bridge to other Bantu languages.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mr-3 mt-1"></i>
                    <div>
                      <strong>Business & Travel:</strong> Essential for anyone interested in East African 
                      business, tourism, or cultural exchange.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mr-3 mt-1"></i>
                    <div>
                      <strong>Rich Literary Tradition:</strong> Access centuries of Swahili poetry, stories, 
                      and modern media from music to films.
                    </div>
                  </li>
                </ul>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Our Kiswahili educators are carefully selected native speakers from Kenya, Tanzania, 
              Uganda, and the Congo who bring authentic pronunciation, cultural knowledge, and a 
              passion for teaching children.
            </p>
            <div className="bg-gray-100 rounded-lg p-8">
              <p className="text-gray-700 italic mb-4">
                "Kiswahili is more than a language—it's a key to understanding the heart of 
                East Africa. When children learn Kiswahili, they gain access to a whole 
                continent of opportunities and connections."
              </p>
              <p className="font-semibold">— Amina M., iSPEAK Kiswahili Educator</p>
            </div>
          </div>
        </section>
