  ...
  const languages = [
    {
      ...
      link: "/plans/yoruba",
      color: "yellow",
      image: "/images/generated/yoruba-culture-card.jpg"
    },
    {
      name: "Kiswahili",
      flag: "🇰🇪",
      ...
      color: "teal",
      image: "/images/generated/kiswahili-culture-card.jpg"
    },
    {
      name: "Twi",
      flag: "🇬🇭",
      ...
      link: "/plans/twi",
      color: "blue",
      image: "/images/generated/twi-culture-card.jpg"
    },
    {
      name: "Amharic",
      flag: "🇪🇹",
      ...
      color: "purple",
      comingSoon: true,
      image: "/images/generated/amharic-culture-card.jpg"
    }
  ]
              ...
              {languages.map((lang, index) => (
                <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden border-2 border-gray-200 hover:shadow-xl transition-shadow">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    <img 
                      src={lang.image} 
                      alt={`${lang.name} cultural elements`} 
