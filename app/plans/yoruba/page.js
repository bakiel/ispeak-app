...
export default function YorubaPlansPage() {
  const plans = [
    {
      name: "Trial Lesson",
      price: "FREE",
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Yoruba Language Programs</h1>
            <p className="text-xl max-w-3xl mx-auto">
              Connect your child with West Africa's rich cultural heritage through engaging 
              Yoruba lessons with native speakers from Nigeria, Benin, and Togo.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6">Why Learn Yoruba?</h2>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mr-3 mt-1"></i>
                    <div>
                      <strong>Cultural Connection:</strong> Yoruba is spoken by over 40 million people 
                      and carries centuries of history, proverbs, and wisdom.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mr-3 mt-1"></i>
                    <div>
                      <strong>Tonal Language Benefits:</strong> Learning Yoruba's tonal system enhances 
                      musical ability and cognitive flexibility.
                    </div>
                  </li>
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mr-3 mt-1"></i>
                    <div>
                      <strong>Diaspora Links:</strong> Connect with Yoruba-speaking communities worldwide, 
                  ...
                  <li className="flex items-start">
                    <i className="fas fa-check-circle text-green-500 mr-3 mt-1"></i>
                    <div>
                      <strong>Rich Oral Tradition:</strong> Access folktales, songs, and cultural practices 
                      that strengthen identity and values.
                    </div>
                  </li>
                </ul>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Our Yoruba educators are carefully selected native speakers from Nigeria, Benin, 
              and Togo who bring authentic pronunciation, cultural knowledge, and a passion for 
              teaching children.
            </p>
            <div className="bg-gray-100 rounded-lg p-8">
              <p className="text-gray-700 italic mb-4">
                "Teaching Yoruba to diaspora children is not just about language—it's about 
                keeping our culture alive for future generations. Every lesson is a bridge 
                between continents and generations."
              </p>
              <p className="font-semibold">— Adunni O., iSPEAK Yoruba Educator</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-yellow-50">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to Start Your Yoruba Journey?</h2>
