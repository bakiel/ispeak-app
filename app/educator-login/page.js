  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.user.role !== 'educator' && data.user.role !== 'admin') {
        setError('This login is for educators only. Please use the student/parent login.')
      ...
      window.location.href = '/portal/educator'
    } catch (err) {
      setError(err.message || 'Invalid educator credentials. Please try again.')
      setLoading(false)
    }
  }
