...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {/* Main Navigation */}
      <nav className="bg-white py-3 md:py-4 shadow-md sticky top-0 z-40">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            {/* Desktop Navigation - Adjusted breakpoint to lg */}
            <div className="hidden lg:flex items-center space-x-4 xl:space-x-6">
              <Link href="/" className="nav-link font-medium text-sm xl:text-base">Home</Link>
            ...
            <Link href="/games" className="nav-link font-medium">
            ...
            <CartIcon />
            <div className="relative group">
              <button className="btn-primary px-4 py-2 rounded-md flex items-center text-sm">
                Login / Register
                <i className="fas fa-chevron-down ml-1 text-xs"></i>
              </button>
      ...
      <div className={`fixed inset-0 bg-white z-50 ${mobileMenuOpen ? 'block' : 'hidden'}`}>
        <div className="p-4">
          ...
          <div className="space-y-4">
            ...
            <Link href="/games" className="block py-2 border-b border-gray-200">
              <i className="fas fa-gamepad mr-2"></i>Games
            </Link>
