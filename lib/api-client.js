...
export const productsAPI = {
  ...
  async getByCategory(categorySlug) {
    return apiFetch(`/products/category/${categorySlug}`)
  },

  async getFeatured() {
    return apiFetch('/products?featured=true&limit=8')
  },
...
export const blogAPI = {
  ...
  async getFeaturedPosts() {
    return apiFetch('/blog/posts?featured=true&limit=3')
  },

  async getRecentPosts(limit = 5) {
    return apiFetch(`/blog/posts?limit=${limit}`)
  }
}
